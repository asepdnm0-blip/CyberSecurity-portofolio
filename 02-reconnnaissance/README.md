...
dan potensi vulnerability di target.
...
|---------------|----------|-----------------------------------------|
| 1–1000 (semua)| filtered | no-response — firewall aktif di target  |
...
- Semua port `filtered` — firewall host aktif menjatuhkan (drop) paket
